...
export interface AdapterInterface {
     ...
     */
    addToChannel(appId: string, channel: string, ws: WebSocket<AppInterface>): Promise<number>;
     ...
     */
    getSockets(appId: string, onlyLocal?: boolean): Promise<Map<string, WebSocket<AppInterface>>>;
     ...
     */
    getChannelSockets(appId: string, channel: string, onlyLocal?: boolean): Promise<Map<string, WebSocket<AppInterface>>>;
