...
export class PublicChannelManager {
     ...
     */
    join(ws: WebSocket<AppInterface>, channel: string, message?: PusherMessage): Promise<JoinResponse> {
     ...
     */
    leave(ws: WebSocket<AppInterface>, channel: string): Promise<LeaveResponse> {
